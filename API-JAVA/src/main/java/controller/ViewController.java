...
public class ViewController {
    ...
    public Boolean verifyUserAndMachine(String login, String senha, String fkMaquina) throws IOException {
        ...
        logs.saveLogs("Aplica��o iniciada por: "+login);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Insira apenas n�meros no id da m�quina");
            System.out.println("\nInsira apenas n�meros no id da m�quina");
            logs.saveLogs("Erro ao iniciar aplica��o");
        }
        if (map.isEmpty()) {
            return false;
        } else {
